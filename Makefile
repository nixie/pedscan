...
CFLAGS = -Wall -Os -Iusbdrv -I$(AVRLIB) -I. -mmcu=atmega8
OBJFLAGS = -j .text -j .data -O ihex
DUDEFLAGS = -p m8 -c usbasp -v

# Object files for the firmware (usbdrv/oddebug.o not strictly needed I think)
OBJECTS = usbdrv/usbdrv.o usbdrv/oddebug.o usbdrv/usbdrvasm.o main.o $(AVRLIB)/spi.o
...
$(CMDLINE): usbtest.c
	gcc -I ./libusb/include -L ./libusb/lib/gcc -O -Wall usbtest.c -o test -lusb
